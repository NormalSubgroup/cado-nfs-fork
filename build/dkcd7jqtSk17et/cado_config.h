...
#define CXXFLAGS    "-export-dynamic -std=c++17 -Wno-c++11-compat -W -Wall -O2  -Wno-literal-suffix -msse3 -mssse3 -msse4.1 -mpopcnt -mavx -mpclmul -mavx2"
#define    ULONG_BITS   64
#define    ULONGLONG_BITS   64

/* #undef CADO_NFS_USE_SHARED_LIBS */

/* #undef HAVE_GDB_PYTHON_PRETTY_PRINT */

#define    HAVE_CXX11

/* #undef HAVE_CXX20 */

#define GMP_INCDIR    "/usr/include/x86_64-linux-gnu"
#define GMP_LIBDIR    "/usr/lib/x86_64-linux-gnu"
#define MPIR_INCDIR    ""
#define MPIR_LIBDIR    ""
/* #undef HAVE_MPIR */
